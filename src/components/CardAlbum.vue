            ...
            <div class="md:flex font-bold text-gray-800">
                ...
                <div class="w-full">
                    <div class="float-right">
                        <button  type="button" class="border border-teal-500 bg-teal-500 text-white px-4 py-2 m-2 ease select-none hover:bg-teal-400 hover:border-gray-900 hover:rounded-md"> + </button>
