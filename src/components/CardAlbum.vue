...
<template>
    <div class="container px-5 mx-auto"  id="card-album" >
        <div class="p-5 bg-white flex items-center mx-auto border-b shadow-md mb-10 border-gray-400 rounded-lg sm:flex-row flex-col">
            ...
            <div class="md:flex font-bold text-gray-800">
                <div class="w-full md:w-1/2 flex space-x-3">
                    <div class="w-1/2">
                    <p>pitchfork pos : #1</p><!-- pitchfork pos  -->
                    </div>
                </div>
                <div class="w-full">
                    <div class="float-right">
                        ...
                        <button  @click="decStock()" :disabled="!album.stock>0" type="button" class="border border-teal-500 bg-teal-500 text-white rounded-md px-4 py-2 m-2 ease select-none hover:bg-purple-800"> - </button>
                    </div>
                </div>
                </div>
            </div>
